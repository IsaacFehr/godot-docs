...
The node appears in the scene tree editor ("Scene" tab in the top-left panel), and the label properties appear in the Inspector (tab in the right-hand panel).
